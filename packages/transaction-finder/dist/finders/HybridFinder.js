...
import { RealtimeFinder } from './RealtimeFinder.js';
...
export class HybridFinder extends EventEmitter {
    ...
    async syncAndMonitor(callbacks) {
        ...
        const stopMonitoring = await this.realtimeFinder.monitorAddresses(this.config.addresses, callbacks || {});
     ...
     */
    async monitorAddresses(callbacks) {
     ...
     */
    async waitForConfirmation(...args) {
...
//# sourceMappingURL=HybridFinder.js.map