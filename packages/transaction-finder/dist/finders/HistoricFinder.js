...
export class HistoricFinder extends EventEmitter {
    ...
    async findUTXOs() {
        ...
        try {
            ...
            const transactions = await this.syncer.syncTransactions(bloomFilter, fromHeight, toHeight, (progress) => this.emit('progress', progress), timeout);
...
//# sourceMappingURL=HistoricFinder.js.map