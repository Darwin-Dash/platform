...
export class DocumentViewer {
  ...
  async loadDocuments(identityId) {
    ...
    try {
      // Get documents for this identity
    ...
    this.container.innerHTML = `
      <div class="documents-viewer">
        <div class="documents-tabs">
          <button class="documents-tab active" data-tab="documents">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              <path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            My Documents (${this.documents.length})
          </button>
          <button class="documents-tab" data-tab="contracts">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              <path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        ...
        <div class="documents-content">
          <div class="tab-panel active" data-panel="documents">
            ${dashPaySection}
            ${contractSections}
          </div>
