 ...
 *
 * Defines all 8 core test cases and worker variants to systematically
 * identify which patterns work and which trigger "already locked to a reader" errors
 */

import type { DiagnosticTestConfig } from './test-framework.js';
...
export const CORE_TEST_CASES = {
   ...
   */
  case2_fresh_worker_per_op: (): DiagnosticTestConfig => ({
   ...
   */
  case3_persistent_worker_sequential: (): DiagnosticTestConfig => ({
   ...
   */
  case4_sdk_cleanup_reinit: (): DiagnosticTestConfig => ({
   ...
   */
  case5_multiple_sdk_instances: (): DiagnosticTestConfig => ({
   ...
   */
  case6_operation_sequences: (): DiagnosticTestConfig => ({
   ...
   */
  case7_wasm_init_patterns: (): DiagnosticTestConfig => ({
   ...
   */
  case8_concurrent_promises: (): DiagnosticTestConfig => ({
...
export const WORKER_VARIANTS = {
   ...
   */
  variantB_pool_2: (): DiagnosticTestConfig => ({
  ...
  variantB_pool_5: (): DiagnosticTestConfig => ({
   ...
   */
  variantC_fresh_instance: (): DiagnosticTestConfig => ({
   ...
   */
  variantD_lazy_sdk: (): DiagnosticTestConfig => ({
...
export const INTEGRATION_SCENARIOS = {
   ...
   */
  realScenario1_parallel_tests: (): DiagnosticTestConfig => ({
   ...
   */
  realScenario3_mixed_operations: (): DiagnosticTestConfig => ({
 ...
 */
export function getAllTestScenarios(): DiagnosticTestConfig[] {
  return [
