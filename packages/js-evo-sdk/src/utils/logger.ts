 ...
 * Universal Logger
 *
 * Lightweight, browser-compatible logging utility for any SDK operations.
 * Respects process.env.LOG_LEVEL without requiring Winston or other heavy dependencies.
 *
 * Designed for multipurpose use across js-evo-sdk and external tools.
 */
...
/**
 * Universal Logger - Structured logging for SDK operations
 *
 * Features:
 ...
 * - Multipurpose design for use across multiple SDK packages
 */
export class Logger {
...
/**
 * Create a logger instance for SDK operations
