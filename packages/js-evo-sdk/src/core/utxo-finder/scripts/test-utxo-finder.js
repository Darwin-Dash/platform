...
const NETWORK_CONFIG = {
  ...
  testnet: {
    name: 'testnet',
    networkType: 'testnet',
    useDapiAddresses: true, // Use whitelist directly to avoid subscription issues
    dapiAddresses: null, // Will be set from networkConfigs.testnet.dapiAddressesWhiteList
    network: 'testnet',
    timeout: 10000,
